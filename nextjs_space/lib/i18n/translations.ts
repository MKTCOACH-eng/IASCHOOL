...
const esTranslations = {
  ...
  affiliate: {
    ...
    referSchools: 'Refiere colegios a IA School y obtén beneficios exclusivos',
    referTitle: 'Refiere Colegios',
    referDesc: 'Identifica colegios que quieran modernizar su gestión escolar',
    setupFee: '10% del Setup',
    setupFeeDesc: 'Recibe el 10% de la cuota de setup cuando el colegio active',
    freeYear: '1 Año Gratis',
    freeYearDesc: 'Si tienes hijos en un colegio con IA School, recibe 1 año gratis para uno de ellos',
    activationWindow: 'Ventana de activación',
    activationDesc: 'El colegio tiene 30 días desde su registro para activar y que recibas tus beneficios.',
    ...
    termsProgram: 'del Programa de Afiliados de IA School',
    createBtn: 'Crear Cuenta',
    haveAccount: '¿Ya tienes cuenta?',
    login: 'Inicia sesión',
    registerSuccess: '¡Registro Exitoso!',
    accountCreated: 'Tu cuenta de afiliado ha sido creada. Redirigiendo al login...',
    portal: 'Portal de Afiliados',
    loginAccess: 'Inicia sesión para acceder a tu dashboard',
    noAccount: '¿No tienes cuenta?',
    registerLink: 'Regístrate como afiliado',
    schoolOrParent: '¿Eres colegio o padre de familia?',
    loginHere: 'Inicia sesión aquí',
    dashboard: 'Panel de Afiliados',
    referredSchools: 'Colegios Referidos',
    activated: 'Activados',
    totalEarned: 'Total Ganado',
    pending: 'Pendiente',
    yourLink: 'Tu Link de Afiliado',
    shareLink: 'Comparte este link con colegios interesados en IA School',
    copy: 'Copiar',
    copied: 'Copiado',
    registerSchool: 'Registrar Colegio',
    trackSchools: 'Registra y da seguimiento a los colegios que refieres',
    noSchools: 'Aún no has referido colegios',
    registerFirst: 'Registra un colegio para comenzar a ganar comisiones',
    registerFirstSchool: 'Registrar mi primer colegio',
    schoolName: 'Nombre del Colegio',
    contactName: 'Nombre del Contacto',
    contactEmail: 'Email del Contacto',
    city: 'Ciudad',
    estimatedStudents: 'Alumnos Estimados',
...
const enTranslations = {
  ...
  affiliate: {
    ...
    referSchools: 'Refer schools to IA School and get exclusive benefits',
    referTitle: 'Refer Schools',
    referDesc: 'Identify schools that want to modernize their school management',
    setupFee: '10% of Setup',
    setupFeeDesc: 'Receive 10% of the setup fee when the school activates',
    freeYear: '1 Free Year',
    freeYearDesc: 'If you have children in a school with IA School, receive 1 free year for one of them',
    activationWindow: 'Activation Window',
    activationDesc: 'The school has 30 days from registration to activate and receive your benefits.',
    ...
    termsProgram: 'of the IA School Affiliate Program',
    createBtn: 'Create Account',
    haveAccount: 'Already have an account?',
    login: 'Login',
    registerSuccess: 'Registration Successful!',
    accountCreated: 'Your affiliate account has been created. Redirecting to login...',
    portal: 'Affiliate Portal',
    loginAccess: 'Login to access your dashboard',
    noAccount: "Don't have an account?",
    registerLink: 'Register as affiliate',
    schoolOrParent: 'Are you a school or parent?',
    loginHere: 'Login here',
    dashboard: 'Affiliate Dashboard',
    referredSchools: 'Referred Schools',
    activated: 'Activated',
    totalEarned: 'Total Earned',
    pending: 'Pending',
    yourLink: 'Your Affiliate Link',
    shareLink: 'Share this link with schools interested in IA School',
    copy: 'Copy',
    copied: 'Copied',
    registerSchool: 'Register School',
    trackSchools: 'Register and track the schools you refer',
    noSchools: 'You have not referred any schools yet',
    registerFirst: 'Register a school to start earning commissions',
    registerFirstSchool: 'Register my first school',
...
const ptTranslations = {
  ...
  affiliate: {
    program: 'Programa de Afiliados', referSchools: 'Indique escolas para IA School e obtenha benefícios exclusivos',
    referTitle: 'Indique Escolas', referDesc: 'Identifique escolas que desejam modernizar sua gestão escolar',
    setupFee: '10% do Setup', setupFeeDesc: 'Receba 10% da taxa de setup quando a escola ativar',
    freeYear: '1 Ano Grátis', freeYearDesc: 'Se você tem filhos em uma escola com IA School, receba 1 ano grátis para um deles',
    activationWindow: 'Janela de Ativação', activationDesc: 'A escola tem 30 dias desde o registro para ativar e você receber seus benefícios.',
    createAccount: 'Criar Conta de Afiliado', fullName: 'Nome completo', email: 'Email', phone: 'Telefone (opcional)',
    password: 'Senha', confirmPassword: 'Confirmar senha', minChars: 'Mínimo 6 caracteres', repeatPassword: 'Repita sua senha',
    acceptTerms: 'Aceito os', termsLink: 'termos e condições', termsProgram: 'do Programa de Afiliados da IA School',
    createBtn: 'Criar Conta', haveAccount: 'Já tem uma conta?', login: 'Entrar', registerSuccess: 'Registro Bem-sucedido!',
    accountCreated: 'Sua conta de afiliado foi criada. Redirecionando para login...', portal: 'Portal de Afiliados',
    loginAccess: 'Entre para acessar seu painel', noAccount: 'Não tem uma conta?', registerLink: 'Registre-se como afiliado',
    schoolOrParent: 'É escola ou pai de família?', loginHere: 'Entre aqui', dashboard: 'Painel de Afiliados',
    referredSchools: 'Escolas Indicadas', activated: 'Ativadas', totalEarned: 'Total Ganho', pending: 'Pendente',
    yourLink: 'Seu Link de Afiliado', shareLink: 'Compartilhe este link com escolas interessadas em IA School',
    copy: 'Copiar', copied: 'Copiado', registerSchool: 'Registrar Escola', trackSchools: 'Registre e acompanhe as escolas que você indica',
    noSchools: 'Você ainda não indicou escolas', registerFirst: 'Registre uma escola para começar a ganhar comissões',
    registerFirstSchool: 'Registrar minha primeira escola', schoolName: 'Nome da Escola', contactName: 'Nome do Contato',
    contactEmail: 'Email do Contato', city: 'Cidade', estimatedStudents: 'Alunos Estimados', additionalNotes: 'Notas adicionais',
    cancel: 'Cancelar', registered: 'Registrado'
  }
};
...
const deTranslations = {
  ...
  affiliate: {
    program: 'Partnerprogramm', referSchools: 'Empfehlen Sie Schulen an IA School und erhalten Sie exklusive Vorteile',
    referTitle: 'Schulen Empfehlen', referDesc: 'Identifizieren Sie Schulen, die ihre Schulverwaltung modernisieren möchten',
    setupFee: '10% der Einrichtung', setupFeeDesc: 'Erhalten Sie 10% der Einrichtungsgebühr, wenn die Schule aktiviert',
    freeYear: '1 Jahr Gratis', freeYearDesc: 'Wenn Sie Kinder in einer Schule mit IA School haben, erhalten Sie 1 Jahr gratis für eines von ihnen',
    activationWindow: 'Aktivierungsfenster', activationDesc: 'Die Schule hat 30 Tage ab der Registrierung Zeit zu aktivieren.',
    createAccount: 'Partner-Konto Erstellen', fullName: 'Vollständiger Name', email: 'E-Mail', phone: 'Telefon (optional)',
    password: 'Passwort', confirmPassword: 'Passwort bestätigen', minChars: 'Mindestens 6 Zeichen', repeatPassword: 'Passwort wiederholen',
    acceptTerms: 'Ich akzeptiere die', termsLink: 'Allgemeinen Geschäftsbedingungen', termsProgram: 'des IA School Partnerprogramms',
    createBtn: 'Konto Erstellen', haveAccount: 'Haben Sie bereits ein Konto?', login: 'Anmelden', registerSuccess: 'Registrierung Erfolgreich!',
    accountCreated: 'Ihr Partner-Konto wurde erstellt. Weiterleitung zum Login...', portal: 'Partner-Portal',
    loginAccess: 'Melden Sie sich an, um auf Ihr Dashboard zuzugreifen', noAccount: 'Kein Konto?', registerLink: 'Als Partner registrieren',
    schoolOrParent: 'Sind Sie eine Schule oder ein Elternteil?', loginHere: 'Hier anmelden', dashboard: 'Partner-Dashboard',
    referredSchools: 'Empfohlene Schulen', activated: 'Aktiviert', totalEarned: 'Gesamt Verdient', pending: 'Ausstehend',
    yourLink: 'Ihr Partner-Link', shareLink: 'Teilen Sie diesen Link mit Schulen, die an IA School interessiert sind',
    copy: 'Kopieren', copied: 'Kopiert', registerSchool: 'Schule Registrieren', trackSchools: 'Registrieren und verfolgen Sie die Schulen, die Sie empfehlen',
    noSchools: 'Sie haben noch keine Schulen empfohlen', registerFirst: 'Registrieren Sie eine Schule, um Provisionen zu verdienen',
    registerFirstSchool: 'Meine erste Schule registrieren', schoolName: 'Schulname', contactName: 'Kontaktname',
    contactEmail: 'Kontakt-E-Mail', city: 'Stadt', estimatedStudents: 'Geschätzte Schüler', additionalNotes: 'Zusätzliche Notizen',
    cancel: 'Abbrechen', registered: 'Registriert'
  }
};
...
const frTranslations = {
  ...
  affiliate: {
    program: 'Programme d\'Affiliation', referSchools: 'Recommandez des écoles à IA School et obtenez des avantages exclusifs',
    referTitle: 'Recommander des Écoles', referDesc: 'Identifiez les écoles qui souhaitent moderniser leur gestion scolaire',
    setupFee: '10% de l\'Installation', setupFeeDesc: 'Recevez 10% des frais d\'installation quand l\'école s\'active',
    freeYear: '1 An Gratuit', freeYearDesc: 'Si vous avez des enfants dans une école avec IA School, recevez 1 an gratuit pour l\'un d\'eux',
    activationWindow: 'Fenêtre d\'Activation', activationDesc: 'L\'école a 30 jours à partir de l\'inscription pour s\'activer.',
    createAccount: 'Créer un Compte Affilié', fullName: 'Nom complet', email: 'E-mail', phone: 'Téléphone (optionnel)',
    password: 'Mot de passe', confirmPassword: 'Confirmer le mot de passe', minChars: 'Minimum 6 caractères', repeatPassword: 'Répétez votre mot de passe',
    acceptTerms: 'J\'accepte les', termsLink: 'termes et conditions', termsProgram: 'du Programme d\'Affiliation IA School',
    createBtn: 'Créer un Compte', haveAccount: 'Vous avez déjà un compte?', login: 'Se Connecter', registerSuccess: 'Inscription Réussie!',
    accountCreated: 'Votre compte affilié a été créé. Redirection vers la connexion...', portal: 'Portail Affiliés',
    loginAccess: 'Connectez-vous pour accéder à votre tableau de bord', noAccount: 'Pas de compte?', registerLink: 'S\'inscrire comme affilié',
    schoolOrParent: 'Êtes-vous une école ou un parent?', loginHere: 'Connectez-vous ici', dashboard: 'Tableau de Bord Affilié',
    referredSchools: 'Écoles Recommandées', activated: 'Activées', totalEarned: 'Total Gagné', pending: 'En Attente',
    yourLink: 'Votre Lien d\'Affilié', shareLink: 'Partagez ce lien avec les écoles intéressées par IA School',
    copy: 'Copier', copied: 'Copié', registerSchool: 'Enregistrer une École', trackSchools: 'Enregistrez et suivez les écoles que vous recommandez',
    noSchools: 'Vous n\'avez pas encore recommandé d\'écoles', registerFirst: 'Enregistrez une école pour commencer à gagner des commissions',
    registerFirstSchool: 'Enregistrer ma première école', schoolName: 'Nom de l\'École', contactName: 'Nom du Contact',
    contactEmail: 'E-mail du Contact', city: 'Ville', estimatedStudents: 'Élèves Estimés', additionalNotes: 'Notes additionnelles',
    cancel: 'Annuler', registered: 'Enregistré'
  },
...
const jaTranslations = {
  ...
  affiliate: {
    program: 'アフィリエイトプログラム', referSchools: 'IA Schoolに学校を紹介して特別な特典を獲得',
    referTitle: '学校を紹介', referDesc: '学校管理を近代化したい学校を見つける',
    setupFee: 'セットアップの10%', setupFeeDesc: '学校がアクティベートするとセットアップ費用の10%を受け取る',
    freeYear: '1年間無料', freeYearDesc: 'IA Schoolを使用している学校にお子様がいる場合、1人分の1年間が無料',
    activationWindow: 'アクティベーション期間', activationDesc: '学校は登録から30日以内にアクティベートする必要があります。',
    createAccount: 'アフィリエイトアカウントを作成', fullName: '氏名', email: 'メール', phone: '電話（任意）',
    password: 'パスワード', confirmPassword: 'パスワードを確認', minChars: '最小6文字', repeatPassword: 'パスワードを再入力',
    acceptTerms: '同意する', termsLink: '利用規約', termsProgram: 'IA Schoolアフィリエイトプログラムの',
    createBtn: 'アカウントを作成', haveAccount: 'アカウントをお持ちですか？', login: 'ログイン', registerSuccess: '登録完了！',
    accountCreated: 'アフィリエイトアカウントが作成されました。ログインにリダイレクト中...', portal: 'アフィリエイトポータル',
    loginAccess: 'ダッシュボードにアクセスするにはログイン', noAccount: 'アカウントがありませんか？', registerLink: 'アフィリエイトとして登録',
    schoolOrParent: '学校または保護者ですか？', loginHere: 'こちらからログイン', dashboard: 'アフィリエイトダッシュボード',
    referredSchools: '紹介した学校', activated: 'アクティベート済み', totalEarned: '合計獲得', pending: '保留中',
    yourLink: 'アフィリエイトリンク', shareLink: 'IA Schoolに興味のある学校とこのリンクを共有',
    copy: 'コピー', copied: 'コピー済み', registerSchool: '学校を登録', trackSchools: '紹介した学校を登録して追跡',
    noSchools: 'まだ学校を紹介していません', registerFirst: 'コミッションを獲得するために学校を登録',
    registerFirstSchool: '最初の学校を登録', schoolName: '学校名', contactName: '連絡先名',
    contactEmail: '連絡先メール', city: '市区町村', estimatedStudents: '推定生徒数', additionalNotes: '追加メモ',
    cancel: 'キャンセル', registered: '登録済み'
  },
